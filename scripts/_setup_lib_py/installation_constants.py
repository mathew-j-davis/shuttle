...
class InstallationConstants:
    ...
    class UserChoiceTracking:
        ...
        CREATE_SOURCE_DIR_CHOICE = "USER_CREATE_SOURCE_DIR_CHOICE"
        CREATE_DEST_DIR_CHOICE = "USER_CREATE_DEST_DIR_CHOICE"
        CREATE_QUARANTINE_DIR_CHOICE = "USER_CREATE_QUARANTINE_DIR_CHOICE"
        CREATE_LOG_DIR_CHOICE = "USER_CREATE_LOG_DIR_CHOICE"
        CREATE_HAZARD_DIR_CHOICE = "USER_CREATE_HAZARD_DIR_CHOICE"
