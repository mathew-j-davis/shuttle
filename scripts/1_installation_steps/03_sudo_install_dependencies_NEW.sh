...
main() {
    ...
    system_packages[apt]="lsof gnupg curl wget"
    system_packages[dnf]="lsof gnupg2 curl wget"
    system_packages[yum]="lsof gnupg2 curl wget"
    system_packages[pacman]="lsof gnupg curl wget"
    system_packages[zypper]="lsof gpg2 curl wget"
    system_packages[brew]="lsof gnupg curl wget"
    system_packages[default]="lsof gnupg curl wget"  # Fallback
    ...
    if check_tools_installation "system dependencies" "lsof:lsof -v 2>&1" "gpg:gpg --version" "curl" "wget"; then
